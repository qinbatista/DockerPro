...
class TestChannel(CommonService):

    def __init__(self):
        super(TestChannel, self).__init__()

    async def process(self, request, _game_name,_channel,_price,_order_id,_des,_production_id,_user_id):
